...
if 'NGF_simple' not in loadCellParams:
    ...
    cellRule['secLists']['spiny'] = ['soma', 'dend']
    netParams.addCellParamsWeightNorm('NGF_simple', 'conn/NGF_reduced_weightNorm.pkl', threshold=cfg.weightNormThreshold)
        ...
        for ipre, preBin in enumerate(bins[binsLabel]):
            for ipost, postBin in enumerate(bins[binsLabel]):
                ...
                netParams.connParams[ruleLabel] = {
                    ...
                    'weight': wmat[('E', postType)][ipost,ipre],
